...
open class ActionControl: UIControl {
    ...
    public init(action: String, height:CGFloat, width: CGFloat) {
        self.action = action
        self.width = width
        self.height = height
...
open class IconAction: ActionControl {
    ...
    public init(action: String,height:CGFloat = 80 ,width: CGFloat = 80, iconSize: CGSize = CGSize(width: 80 , height: 80)) {
        self.iconSize = iconSize
        super.init(action: action,height:height, width: width)
...
open class TextAction: ActionControl {
    ...
    public override init(action: String, height: CGFloat = 80, width: CGFloat = 80) {
        super.init(action: action,height:height, width: width)
...
open class IconTextAction: ActionControl {
    ...
    public init(action: String, width: CGFloat = 80, iconSize: CGSize = CGSize(width: 20, height: 20), space: CGFloat = 5, offset: CGFloat = -3) {
        ...
        self.space = space
        self.offset = offset
        super.init(action: action,height:80.0, width: width)
