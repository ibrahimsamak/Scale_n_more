...
class MyTools{
    ...
    func convertDateToString20(_ date: Date) -> String {
    ...
    func convertDateFormater3(date: Date) -> String {
    ...
    func checkMealPackage() -> Int
    {
        let ns = UserDefaults.standard
        let dict = ns.value(forKey: "CurrentUser") as! NSDictionary
        let check_meal = dict.value(forKey: "check_meal") as! Int
        return check_meal
    }
    ...
    func getConfigString(_ key1:String) -> String
    {
        let ns = UserDefaults.standard
        let val = ns.value(forKey: key1) as? String ?? ""
        return val
    }
    
    
    func getStatic(_ dic:String , _ lang:String, _ key:String) -> String
    {
        let ns = UserDefaults.standard
        let dic = ns.value(forKey: dic) as! NSDictionary
        let translations = dic.value(forKey: "translations") as! NSArray
        if(lang.contains("ar")){
            let contetn = translations[0] as! NSDictionary
            let desc = contetn.value(forKey: "key") as! String
            return desc
        }
        else{
            let contetn = translations[1] as! NSDictionary
            let desc = contetn.value(forKey: "key") as! String
            return desc
        }
    }
    ...
    {
        let ns = UserDefaults.standard
        let key = ns.value(forKey: "Ads") as! NSDictionary
        let val = key.value(forKey: "image") as! String
        return val
    }
...
//    }
    ...
    func convertStringToDate2 (date: String) -> Date
    {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd"
    ...
    func convertStringToDate (date: String) -> Date
    {
        ...
        let date = dateFormatter.date(from: date) as? Date ?? Date()
        return date
    }
